...
payload = {
    ...
    "prompt": (
                ...
                ""
                "\n\nEDUCATION TITLE/DEGREE/DEPARTMENT RULE: For entries "
                "labeled 'Education', follow the examples."
                "\nExample: 'Master of Science (MSc) (Process Engineering) "
                "(The Graduate Program in Process Engineering (PPGEP))' has "
                "exactly THREE top-level groups: 'MSc', 'Process "
                "Engineering', and 'The Graduate Program in Process "
                "Engineering (PPGEP)' -- the inner '(PPGEP)' is part of the "
                "third group, not a fourth group. Applying Steps 1-3: "
                "degree = 'Master of Science (MSc)', title = 'Process "
                "Engineering', department = 'The Graduate Program in "
                "Process Engineering (PPGEP)'. " 
                ""
